...
// ─── BRAND ────────────────────────────────────────────────────────────────────
// Colors pulled from actual logo: pink→orange ring, neon chartreuse cat
const BRAND = {
  name:     'Alley Cat Music Club',
  handle:   '@alleycatmusic',
  city:     'Atlanta, GA',
  genre:    'House / Techno',
  website:  'alleycatmusic.club',
  gradient:      'linear-gradient(135deg, #dd22aa 0%, #f07020 100%)',
  gradientAngle: 'linear-gradient(160deg, #dd22aa, #f07020)',
  pink:    '#dd22aa',
  orange:  '#f07020',
  neon:    '#aaff00',   // the chartreuse cat color
}
...
// ─── ALLEYCAT LOGO ────────────────────────────────────────────────────────────
const LOGO_URL = 'https://elkfhmyhiyyubtqzqlpq.supabase.co/storage/v1/object/public/alleycat/Screenshot%202026-04-14%20at%207.37.32%20PM.png'

function AlleycatLogo({ size = 80 }) {
  return (
    <img
      src={LOGO_URL}
      alt="Alley Cat Music Club"
      width={size}
      height={size}
...
const EVENT = {
  ...
  barPct:  25,
  producers: [
    { name: 'Akarsh',       role: 'Promoter',     split: 60 },
  ...
  return (
    <div style={{
      ...
      <div style={{ padding: '1rem 1.2rem', borderBottom: `1px solid ${C.border}` }}>
        ...
        {[
          { name: 'DJ / Talent',   amount: EVENT.costs.dj,       by: 'Akarsh' },
          { name: 'Sound System',  amount: EVENT.costs.sound,    by: 'Venue' },
          { name: 'Security',      amount: EVENT.costs.security, by: 'Akarsh' },
    ...
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3rem', alignItems: 'start' }}>
      ...
      <div style={{ background: '#0d0d14', border: `1px solid ${connected ? BRAND.neon + '33' : C.border}`, borderRadius: '20px', overflow: 'hidden', transition: 'border-color 0.4s' }}>
        ...
        <div style={{ padding: '1.1rem 1.3rem', borderBottom: `1px solid ${C.border}`, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div style={{ fontSize: '0.82rem', color: C.textMid, fontWeight: '600' }}>Alley Cat Music Club</div>
          {connected
          ...
          {!connected ? (
            <div style={{ padding: '2rem 1.3rem', textAlign: 'center' }}>
              ...
              <div style={{ color: C.textMid, fontSize: '0.75rem', marginTop: '0.8rem', lineHeight: 1.5 }}>
                Your payout account. GRAIL takes 2% of ticket sales — nothing else.
              </div>
            </div>
          ) : (
            <div>
        ...
        {connected && balance >= 105 && (
          <div style={{ padding: '0.9rem 1.3rem', borderTop: `1px solid ${C.border}`, background: '#0a1400', display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
            ...
            <div style={{ fontSize: '0.78rem', color: BRAND.neon, lineHeight: 1.4 }}>
              <strong>Venue deposit paid.</strong> ${Math.floor(balance * 0.4).toLocaleString()} transferred to Alley Cat's account.
            </div>
          </div>
        )}
      </div>
    ...
    <div style={{ background: '#0a0a0a', minHeight: '100%' }}>
      ...
      <div style={{ padding: '1rem 1.2rem', borderBottom: '1px solid #1a1a24', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div>
          ...
          <div style={{ fontSize: '0.72rem', color: '#8a8098' }}>May 2 · Alley Cat</div>
        </div>
        {itemCount > 0 && (
...
// ─── MAIN ──────────────────────────────────────────────────────────────────────
export default function AlleycatDemo() {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.7rem' }}>
          ...
          <span style={{ color: C.text, fontWeight: '700', fontSize: '0.9rem' }}>Alley Cat</span>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
          <span style={{
            fontSize: '0.7rem',
          ...
          <a
            href="mailto:jp@casadecopas.com?subject=Alley Cat × GRAIL"
            style={{
        ...
        <Section>
          <div style={{ marginBottom: '1.5rem' }}>
            ...
            <div style={{ color: C.textMid, fontSize: '0.88rem' }}>
              This is what Akarsh and the venue see when they sit down together.
        ...
        <Section>
          ...
          <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
            ...
            <div style={{ color: C.textMid, fontSize: '0.9rem', maxWidth: '460px', margin: '0 auto', lineHeight: 1.7 }}>
              2% on ticket sales. 2% on bar revenue. No per-ticket fees, no payment processing markup, no payout delays.
      ...
      <div style={{
        ...
        <div style={{
          ...
          Ready to run Alley Cat on GRAIL?
        </div>
        ...
        <a
          href="mailto:jp@casadecopas.com?subject=Alley Cat × GRAIL — Let's talk"
          style={{
            display: 'inline-block',
            background: BRAND.gradient,
            color: '#000',
