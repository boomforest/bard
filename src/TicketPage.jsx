...
export default function TicketPage() {
  ...
  const promoActive = promoApplied && (promoCode.trim().toUpperCase() === 'MARCARIO' || promoCode.trim().toUpperCase() === 'DJFRIEND' || promoCode.trim().toUpperCase() === 'NLNR10' || new Date() < PROMO_ENDS);
  ...
  const handlePromoApply = () => {
    ...
    if (code === 'MARCARIO' || code === 'DJFRIEND' || code === 'NLNR10' || (code === 'FF' && new Date() < PROMO_ENDS)) {
